...
function Footer() {
    return (
        <div className='w-full h-screen bg-zinc-900 p-20 flex'>
            <div className="w-1/2 h-full font-['Founders_Grotesk_X_condensed', Helvetica, sans-serif] flex flex-col justify-between">
                <div>
                    <h1 className='text-[7vw] uppercase leading-none font-bold'>Eye-</h1>
                    <h1 className='text-[7vw] uppercase leading-none font-bold'>Opening</h1>
                </div>
            ...
            <div className="w-1/2 gap-5">
                <h1 className="text-[6vw] uppercase leading-none font-bold font-['Founders_Grotesk_X_condensed', Helvetica, sans-serif]">Presentation</h1>
                <div className='pl-24 pt-[35vh]'>
                        <p>S:</p>
                        <div className='mt-3'>
                            <p>Instagram</p>
                            <p>Behance</p>
